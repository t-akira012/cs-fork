...
" Editor colors
call s:hi("TabLine",      s:gui.comment,    s:gui.none,        "", "", "none")
call s:hi("TabLineSel",   s:gui.green,      s:gui.selection,   "", "", "none")
call s:hi("TabLineFill",  s:gui.background, s:gui.none,        "", "", "")
...
call s:hi("Title",       s:gui.cyan,       "",               "", "", "underline")
...
call s:hi("Todo",        s:gui.green,      s:gui.none,       "", "", "underline")
